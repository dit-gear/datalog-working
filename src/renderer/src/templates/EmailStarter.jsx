...
// You can use components from react-email directly without importing. 
// See react-email documentation https://react.email/docs
// Dynamic data from datalog is available on data-prop, example: {data.selected.name} will get the name of the selected log.
    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={title}>
            Datalog - Day <strong>{data.selected.day}</strong> of {data.target.days}
          </Text>
